...
public class JServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // this line sets up the server to pick up JNDI related configurations in override-web.xml. This is a direct copy of the documentation, excluding jetty-env.xml processing class.
        classlist.addAfter("org.eclipse.jetty.webapp.FragmentConfiguration","org.eclipse.jetty.plus.webapp.PlusConfiguration");
